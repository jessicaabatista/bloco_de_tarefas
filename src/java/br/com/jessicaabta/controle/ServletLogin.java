...
public class ServletLogin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Usuario usuario = new UsuarioDAOImpl().buscar(new Usuario(request.getParameter("anotacao"), request.getParameter("senha")));
        ...
        if (usuario.getId() != -1) {
            ...
            request.setAttribute("anotacao", Util.decodificar(usuario.getTarefa()));
