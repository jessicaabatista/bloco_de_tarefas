...
import br.com.jessicaabta.controle.Util;
...
public class UsuarioDAOImpl implements UsuarioDAO {
    ...
    public void cadastrar(Usuario usuario)
        ...
        try {
            ps = con.prepareStatement("INSERT INTO usuario(anotacao, senha) VALUES(?, ?)");
            ps.setString(1, usuario.getTarefa());
    ...
    public Usuario buscar(Usuario usuario) {
        ...
        try {
            ps = con.prepareStatement("SELECT id, senha FROM usuario WHERE anotacao = ?");
            ps.setString(1, usuario.getTarefa());
