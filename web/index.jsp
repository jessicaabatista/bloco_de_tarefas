        ...
        <div class="container-fluid">
            <div class="row">
                <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-2 col-xs-offset-1 col-sm-offset-4 col-md-offset-4 col-lg-offset-5 text-center">
                    <h3>Projeto Bloco de Tarefas</h3>
                    <h3>Bem-vindo</h3>
                </div>
            </div>
            <br>
            ...
            <form action="login" method="POST">
                <div class="row">
                    <div class="form-group col-xs-10 col-sm-6 col-md-4 col-lg-4 col-xs-offset-1 col-sm-offset-3 col-md-offset-4 col-lg-offset-4 text-center">
                        <label for="anotacao">Usuário:</label>
                        <input type="text" maxlength="20" class="form-control text-center" id="anotacao" placeholder="Digite seu anotacao" name="anotacao"
                               required oninvalid="this.setCustomValidity('Entre com seu anotacao de usuário.')" oninput="this.setCustomValidity('')"
                               value="${anotacao}">
                    </div>
                </div>
                <div class="row">
